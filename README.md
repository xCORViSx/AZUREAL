...
- **Rebase Support** — Rebase-before-merge ensures clean squash merges; manual rebase action (`r`) in Git panel; conflict detection with structured overlay and RCR resolution
