...
- **Completion Notifications** — macOS notification when any Claude instance finishes; shows `worktree:session_name` so you know which instance completed, even while in another app
