...
//! - `keys`: Shared alternative key arrays, modifier combos, platform key consts
//! - `panes`: Core pane arrays (global, worktrees, file tree, viewer, edit, session, input, terminal)
//! - `modals`: Modal panel arrays (health, git, projects, picker, branch dialog)
