...
│   ├── config.rs           # Configuration (nerd_fonts, permissions, API key), Claude session discovery, projects persistence
│   ├── main.rs             # Entry point
