...
- `src/app/session_store.rs` - `SessionStore`, `SessionInfo`, `CompactionInfo`, `ContextPayload`, `open()`, `create_session()`, `rename_session()`, `delete_session()`, `list_sessions()`, `append_events()`, `load_events()`, `build_context()`, `store_compaction()`
