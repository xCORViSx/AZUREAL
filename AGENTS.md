...
- `src/app/session_cache.rs` - `CachedSession`, `CacheIndex`, `resolve_cache_name()`, `lookup_cache_name()`, `read_cache()`, `read_cache_orphan()`, `write_cache()`, `migrate_legacy_caches()`, `backend_from_path()`
