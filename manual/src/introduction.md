...
Version **0.7.0** | MIT License | Author: xCORViSx
...
> **Note:** AZUREAL is pre-release software (v0.7.0). Features, keybindings, and configuration formats may change between versions. This manual tracks the current release.
